...
export const resolvers = {
  ...
  Channel: {
    messageFeed: (channel, { cursor }) => {
      ...
      if (!cursor) {
        cursor =
          channel.messages[channel.messages.length - 1].createdAt || 123;
      }
      ...
      const newestMessageIndex = channel.messages
        .findIndex(message => message.createdAt === cursor); 
      ...
      const newCursor =
        channel.messages[newestMessageIndex - limit].createdAt || 123;
